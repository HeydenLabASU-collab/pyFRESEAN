...
#SBATCH --chdir=/home/athiru12/Research_experiments_sol/code/FRESEAN_project/FRESEAN_tutorial/pyfresean/pyfresean/tests/data/fresean_c_ref/hewl_solution_303K
#SBATCH --output=slurm_%j.out
#SBATCH --error=slurm_%j.err

# 0.1 ns HEWL-in-solution MD from imd-workshop-2025 input (TRR with velocities).
